...
function update_statistics(start, end) {
    ...
    $('.total_cash_sales').html(loader);
    $('.total_receivable').html(loader);
    $('.net').html(loader);
    $('.stock_value').html(loader);
    $('.total_suppliers').html(loader);
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('.total_receivable').html(__currency_trans_from_en(data.total_receivable, true));
            $('.total_payable').html(__currency_trans_from_en(data.total_payable, true));
            $('.stock_value').html(__currency_trans_from_en(data.stock_value, true));
