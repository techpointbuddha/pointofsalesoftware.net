            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'view_customer_ledger', in_array('view_customer_ledger', $role_permissions),
                               [ 'class' => 'input-icheck']); !!} View Customer Ledger
                            </label>
                        </div>
                        <hr>
                    </div>
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'show_received_status', in_array('show_received_status', $role_permissions),
                                    ['class' => 'input-icheck']); !!}
