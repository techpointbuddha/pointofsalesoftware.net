    	    ...
    	    <!-- /.col -->
          	...
          	<div class="row">
                ...
                <span class="info-box-icon bg-red-active">
                  ...
                  <span class="info-box-text">
                    Total Receivable
                            ...
                            <span class="info-box-number total_receivable"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                Total Payable Amount
                            ...
                            <span class="info-box-number total_payable"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
              ...
              Total Stock Value
                            ...
                            <span class="info-box-number stock_value"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
              ...
              Total Suppliers
                            ...
                            <span class="info-box-number total_suppliers"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                            ...
                            @if(count($all_locations) > 1)
                                <div class="col-md-4 col-sm-12 mb-10">
                                    <div class="form-group">
                                        <label for="stock_alert_location">Location</label>
                            ...
                            @endif
                                ...
                                <div class="col-md-4 col-sm-12 mb-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('sub_category_id', [], null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2','id' => 'product_list_filter_sub_category_id',]); !!}
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        sell_table = $('#shipments_table').DataTable({
            ...
            columns: [
                ...
                { data: 'business_location', name: 'bl.name'},
                { data: 'shipping_status', name: 'shipping_status'},
                 { data: 'comission_user_name', name: 'u.first_name'},
                @if(!empty($custom_labels['shipping']['custom_field_1']))
