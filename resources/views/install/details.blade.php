...
<div class="container">
    <div class="row">
        <h3 class="text-center">Online Office POS Installation <small>Step 2 of 3</small></h3>
              ...
              <form class="form" id="details_form" method="post" 
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="APP_NAME" id="app_name" placeholder="Online Office POS" required >
                    </div>
                  </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="envato_purchase_code">Purchase Code:*</label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="MAIL_FROM_ADDRESS" name="MAIL_FROM_ADDRESS" placeholder="hello@onlineofficepos.com" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="MAIL_FROM_NAME" name="MAIL_FROM_NAME" placeholder="Online Office POS (Optional)">
                    </div>
                  </div>
