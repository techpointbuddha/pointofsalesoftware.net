<div class="pos-tab-content">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('square_public_key', __('lang_v1.square_public_key') . ':') !!}
                {!! Form::text('pos_settings[square_public_key]', $pos_settings['square_public_key'] ?? '', ['class' => 'form-control', 'id' => 'square_public_key']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('square_secret_key', __('lang_v1.square_secret_key') . ':') !!}
                {!! Form::text('pos_settings[square_secret_key]', $pos_settings['square_secret_key'] ?? '', ['class' => 'form-control', 'id' => 'square_secret_key']); !!}
            </div>
        </div>
    </div>
</div>