...
<script>
  ...
  function initAutocomplete() {
    ...
    var address_line_2 = document.getElementById('address_line_2');
    var input = document.getElementById('shipping_address');
    var address_line_1_search_box = new google.maps.places.SearchBox(address_line_1);
    var address_line_2_search_box = new google.maps.places.SearchBox(address_line_2);
