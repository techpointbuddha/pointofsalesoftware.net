                            ...
                            id="product_sell_report_table">
                                ...
                                <tfoot>
                                    <tr class="bg-gray font-17 footer-total text-center">
                                        ...
                                        <td></td>
                                        <td><span class="display_currency" id="footer_goodsprice" data-currency_symbol ="true"></span></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td id="footer_tax"></td>
                                        <td><span class="display_currency" id="footer_subtotal" data-currency_symbol ="true"></span></td>
                                        <td><span class="display_currency" id="footer_grossprofit" data-currency_symbol ="true"></span></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
