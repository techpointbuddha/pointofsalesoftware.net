	...
	<tr>
		<td>
			...
			<div class="row invoice-info">
				...
				<div class="col-md-6 invoice-col width-50" style="color: black !important;">
			...
			<div class="row invoice-info color-555">
				<br/>
				<div class="col-md-6 invoice-col width-50 word-wrap" style="color: black !important;">
			...
			<div class="row color-555">
				<div class="col-xs-12">
					...
					<table class="table table-bordered table-no-top-cell-border">
						<thead>
						<tr style=" color: black !important; font-size: 20px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
							<td style=" color: black !important; width: 5% !important; font-weight: bold">#</td>

							<td style=" color: black !important; width: 65% !important ; font-weight: bold">
								{{$receipt_details->table_product_label}}
							</td>

							<td style=" color: black !important; width: 30% !important; font-weight: bold">
