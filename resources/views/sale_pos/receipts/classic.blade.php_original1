...
<div class="row">
	...
	<div class="col-xs-12 text-center">
		...
		@if(!empty($receipt_details->contact))
			<br/>{!! $receipt_details->contact !!}454545
		@endif	
		...
		@if(!empty($receipt_details->invoice_no))
			<b style="font-size: 25px;">@lang('restaurant.order_no') : {{substr($receipt_details->invoice_no, -3)}}</b> 
		@endif
        ...
        <div class="table-responsive">
          	<table class="table table-slim">
				<tbody>
					...
					<!-- Total -->
					<tr>
    <th style="width: 850%;"> <!-- Adjust the width as needed -->
        {!! $receipt_details->total_label !!}
    </th>
    <td class="text-left" style="width: 700%;"> <!-- Adjust the width as needed -->
