...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('find-price', 'HomeController@findPrice');
    Route::get('find-product', 'HomeController@findProduct')->name('find_product');
    Route::get('packages', 'HomeController@packages')->name('packages');
    Route::get('package/create', 'HomeController@packageCreate')->name('packageCreate');
    Route::post('package/save', 'HomeController@packageSave')->name('packageSave');
    Route::get('package/edit/{package}', 'HomeController@packageEdit')->name('packageEdit');
    Route::get('package/delete/{package}', 'HomeController@packageDelete')->name('packageDelete');
    Route::post('package/update/{package}', 'HomeController@packageUpdate')->name('packageUpdate');
    Route::post('/get-package-detail', 'HomeController@getPackageDetail');
    Route::post('update-package-rows/{package}', 'HomeController@updatePackageRows')->name('updatePackageRows');


    Route::get('get-package-product/{variation_id}', 'HomeController@getPackageProduct')->name('getPackageProduct');
