    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $datatable = Datatables::of($sells)
                ...
                ->editColumn(
                    'shipping_charges',
                    '<span class="shipping_charges" data-orig-value="{{$shipping_charges}}">@format_currency($shipping_charges)</span>'
                )
                ->editColumn(
                    'total_before_tax',
            ...
            $rawColumns = ['final_total','shipping_charges', 'action', 'total_paid', 'total_remaining', 'payment_status', 'invoice_no', 'discount_amount', 'tax_amount', 'total_before_tax', 'shipping_status', 'types_of_service_name', 'payment_methods', 'return_due', 'conatct_name', 'status'];
    ...
    public function edit($id)
    {
        ...
        return view('sell.edit')
            ->with(compact('business_details', 'taxes', 'sell_details', 'transaction', 'commission_agent', 'types', 'customer_groups',
                'pos_settings', 'waiters', 'invoice_schemes', 'default_invoice_schemes',
                'redeem_details', 'edit_discount', 'edit_price', 'shipping_statuses',
                'warranties', 'statuses', 'sales_orders', 'payment_types', 'accounts', 'payment_lines',
                'change_return', 'is_order_request_enabled', 'customer_due', 'users','weight_scale'));
    }
