    ...
    public function postDetails(Request $request)
    {
        ...
        try {
            ...
            $validatedData = $request->validate(
                ...
                'ENVATO_PURCHASE_CODE' => ['required', function($attribute, $value, $fail) {
                    
                    if ($value !== '12345678') {
                        $fail('Invalid license code, please enter correct license code.');
                    }
                }],
            ...
            $input = $request->only(['APP_NAME', 'APP_TITLE', 'DB_HOST', 'DB_PORT', 'DB_DATABASE','DB_PASSWORD', 'DB_USERNAME', 'MAIL_DRIVER',
            ...
            if (mysqli_connect_errno()) {
                ...
                $msg .= "<br/>Provide correct details for 'Database Host', 'Database Port', 'Database Name', 'Database Username'.";
                return redirect()
                    ->back()
                    ->with('error', $msg);
            }
